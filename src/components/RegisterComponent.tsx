...
export const RegisterComponent: React.FC<RegisterComponentProps> = ({
  ...
  <style jsx global>{`
    .h-[28rem]::-webkit-scrollbar {
      width: 4px;
    }

    .h-[28rem]::-webkit-scrollbar-track {
      background: transparent;
    }

    .h-[28rem]::-webkit-scrollbar-thumb {
      background: #e2e8f0;
      border-radius: 2px;
    }

    .h-[28rem]::-webkit-scrollbar-thumb:hover {
      background: #cbd5e1;
    }
  `}</style>;

  return (
    <div className="min-h-screen flex items-center justify-center bg-gradient-to-br from-slate-900 via-blue-900 to-indigo-900 p-4 sm:p-6 lg:p-8">
      {/* Main Container - Wrapped Card */}
      <div className="w-full max-w-6xl bg-white rounded-3xl shadow-2xl overflow-hidden backdrop-blur-sm border border-white/10">
        <div className="flex flex-col lg:flex-row min-h-[600px]">
          ...
          <div className="lg:w-1/2 relative overflow-hidden">
            ...
            <div className="relative w-full h-64 lg:h-full">
              ...
              <div className="absolute bottom-12 left-0 right-0 text-white z-10 px-6 lg:px-8">
                <div className="space-y-3 transform transition-all duration-1000">
                  ...
                  <div className="w-16 h-0.5 bg-white/60 rounded-full"></div>
                  <p className="text-sm lg:text-base opacity-80 max-w-sm leading-relaxed">
          ...
          <div className="lg:w-1/2 flex items-center justify-center p-6 lg:p-12 bg-white relative">
            ...
            >
              ...
              <div className="bg-white py-8 px-6 relative overflow-hidden mt-8">
                <div
                  className="relative h-[28rem] overflow-y-auto pr-2"
                  style={{
                    scrollbarWidth: "thin",
                ...
                >
                  <div className="space-y-5">
                    ...
                    <div className="group">
                      ...
                      <div className="relative">
                        ...
                        <input
                          ...
                          className="w-full pl-10 pr-3 py-3 bg-gray-50 border border-gray-300 placeholder-gray-500 text-gray-900 rounded-xl focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-blue-500 transition-all duration-200 text-base"
                    ...
                    <div className="group">
                      ...
                      <div className="relative">
                        ...
                        <input
                          ...
                          className="w-full pl-10 pr-12 py-3 bg-gray-50 border border-gray-300 placeholder-gray-500 text-gray-900 rounded-xl focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-blue-500 transition-all duration-200 text-base"
                          placeholder="••••••••"
                          disabled={loading || gmailLoading}
                          style={{ fontSize: "16px" }}
                        />
                        {isPasswordTyping && (
                          <button
                            ...
                            className="absolute top-1/2 right-3 -translate-y-1/2 focus:outline-none p-2 rounded-lg hover:bg-gray-100 transition-all duration-200 min-h-[44px] min-w-[44px] flex items-center justify-center"
                          >
                            {showPassword ? (
                    ...
                    <button
                      ...
                      disabled={loading || gmailLoading}
                      className="w-full flex justify-center py-3 px-4 border border-transparent text-base font-semibold rounded-xl text-white bg-gradient-to-r from-blue-600 to-blue-700 hover:from-blue-700 hover:to-blue-800 focus:outline-none focus:ring-2 focus:ring-blue-500/50 disabled:opacity-50 disabled:cursor-not-allowed transition-all duration-200 shadow-md hover:shadow-lg min-h-[48px]"
                      style={{ fontSize: "16px" }}
                    >
                      {loading ? (
                    ...
                    <div className="text-center pt-2">
                      <div className="flex flex-col sm:flex-row justify-center items-center text-sm gap-1">
                        ...
                        <button
                          ...
                          className="font-semibold text-blue-600 hover:text-blue-700 transition-colors duration-200 hover:underline px-2 py-1 rounded min-h-[44px] flex items-center justify-center"
                          disabled={loading || gmailLoading}
                        >
                          Sign in instead
                        </button>
